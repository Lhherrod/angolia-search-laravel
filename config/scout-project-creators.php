...
return [
    ...
    */
    ...
    'searchableAttributes' => ['project_creator_name'],
    ...
    */
    ...
    'customRanking' => [
        'desc(number_of_projects)',
        'desc(number_of_completed_projects)',
        'desc(number_of_non_completed_projects)',
        'desc(number_of_deployed_projects)',
        'desc(number_of_current_projects_in_production)',
        'desc(number_of_current_projects_in_development)',
    ],
